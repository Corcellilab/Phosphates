...
Gyra = False
time_corr = [False, 192, 1, 200, 5, 100]      # -, number of molecules, min_spacer_size, max_space_size, spacer_size_interval, spacer_jump 
branches = True
ion_pairs = [False,'1','5',[0,3.15]]        # -, atom_type1, atom_type2, Distance Check
